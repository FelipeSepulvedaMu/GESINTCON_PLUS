    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl p-10 z-10 border border-slate-100 animate-in zoom-in duration-300">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-slate-900 mb-2 uppercase tracking-tighter">GESINTCON PLUS</h1>
          <p className="text-slate-400 font-bold uppercase text-[10px] tracking-[0.2em]">Gestión Inteligente de Condominios</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block ml-4">Correo Electrónico</label>
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block ml-4">Contraseña</label>
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                <Lock size={18} />
              </span>
        ...
        <div className="mt-10 text-center">
          <p className="text-[9px] font-black text-slate-300 uppercase tracking-widest">GESINTCON v1.0 ERP Cloud System</p>
        </div>
      </div>
    </div>
  );
